 ...
 */
import type { Camera, OrthographicCamera, PerspectiveCamera, Scene} from "three/src/Three";
...
export class CSS3DRenderer {
    ...
    private renderObject(object: Object3D, scene: Scene, camera: Camera, cameraCSSMatrix: string): void {
