...
describe("index Test", () => {
    ...
    it("Css2DLineRenderer export", () => expect(Index.Css2DLineRenderer).toBeDefined());
    it("Css2DEdgeRenderer export", () => expect(Index.Css2DEdgeRenderer).toBeDefined());
    it("Css2DPolygonRenderer export", () => expect(Index.Css2DPolygonRenderer).toBeDefined());
